...
async def start_cmd(bot, msg):
    ...
    btn = InlineKeyboardMarkup([[
        ...
        InlineKeyboardButton("🖥️ How To Deploy", url="https://t.me/Tamilan224")
    ]])
...
async def start(bot, msg, cb=True):   
    txt=f"hai {msg.from_user.mention} i am simple rename bot with personal usage.\nthis bot is made by <b><a href=https://t.me/Tamilan224>Horror_Movies_Tamil</a></b>"                                     
    button= [[
        InlineKeyboardButton("👻 Horror Updates", url="https://t.me/Tamilan224")
        ],[
...
async def about(bot, msg):
    me=await bot.get_me()
    Master=f"<a href=https://t.me/Tamilan224>Horror_Movies_Tamil</a> & <a href=https://t.me/+BMnH-D8PgTYxZTk1>Anime Warriors Tamil</a>"  
    Source="<a href=https://github.com/MrMKN/Simple-Rename-Bot>Click Here</a>"
    txt=f"<b>Bot Name: {me.mention}\nDeveloper: <a href=https://t.me/Tamilan224>Horror_Movies_Tamil</a>\Annime Updates: <a href=https://t.me/+BMnH-D8PgTYxZTk1>Anime_Warriors_Tamil</a>\nMy Master's: {Master}\nSource Code: {Source}</b>"                 
    button= [[        
        InlineKeyboardButton("🚫 Close", callback_data="del"),
        InlineKeyboardButton("⬅️ Back", callback_data="start") 
    ]]  
